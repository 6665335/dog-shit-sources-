-- leaked by splitta get back for slatti frame and encode
...
local Yung =
loadstring(game:HttpGet("https://paste.website/p/e67aed1a-9554-4b32-b6e9-c32ae5b59e31.txt"))() -- This is not mine
...
local library = loadstring(game:HttpGet("https://paste.website/p/2776277f-a084-4205-92b5-e724cd8d7f1f.txt"))({cheatname = "Arabic", gamename = "Da Hood"})
library:init()

local menu = library.NewWindow({title = "wwwwww bob", size = UDim2.new(0, 500, 0.7, 146.7)})
